...
export const vocabulary = [
  ...
  { word: "Cheers", phonetic: "[Çiyrz]", meaning: "Teşekkürler / Şerefe / Hoşça kal", example: "Cheers, mate! See you tomorrow.", exampleTr: "Teşekkürler dostum! Yarın görüşürüz.", context: "Günlük" },
  { word: "Mate", phonetic: "[Meyt]", meaning: "Arkadaş, dost (çok yaygın hitap)", example: "All right, mate?", exampleTr: "İyi misin dostum?", context: "Günlük" },
  { word: "Brilliant", phonetic: "[Brilyınt]", meaning: "Harika, çok iyi, müthiş", example: "That's a brilliant idea.", exampleTr: "Bu harika bir fikir.", context: "Günlük/İş" },
  { word: "Mind the gap", phonetic: "[Maynd dı gep]", meaning: "Metro ile peron arasındaki boşluğa dikkat edin", example: "Please mind the gap between the train and the platform.", exampleTr: "Lütfen tren ile peron arasındaki boşluğa dikkat edin.", context: "Seyahat" },
  { word: "Sorted", phonetic: "[Sortıd]", meaning: "Halledildi, ayarlandı, sorun çözüldü", example: "I've sent the email. It's all sorted.", exampleTr: "E-postayı gönderdim. Hepsi halledildi.", context: "İş/Günlük" },
  { word: "Quid", phonetic: "[Kuid]", meaning: "Pound (£) için kullanılan yaygın argo (Çoğul eki almaz)", example: "That coffee cost me four quid.", exampleTr: "O kahve bana dört pound'a mal oldu.", context: "Günlük" },
  { word: "Fiver / Tenner", phonetic: "[Fayvır / Tenır]", meaning: "5 Pound / 10 Pound banknot", example: "Can you lend me a tenner?", exampleTr: "Bana 10 pound ödünç verebilir misin?", context: "Günlük" },
  { word: "Posh", phonetic: "[Poş]", meaning: "Lüks, havalı veya üst sınıf", example: "We went to a very posh restaurant in Mayfair.", exampleTr: "Mayfair'de çok lüks bir restorana gittik.", context: "Günlük" },
  { word: "Knackered", phonetic: "[Nekırd]", meaning: "Çok yorgun, bitkin, tükenmiş", example: "I was absolutely knackered after the long flight.", exampleTr: "Uzun uçuştan sonra tamamen bitkin düşmüştüm.", context: "Günlük" },
  { word: "Loo", phonetic: "[Luu]", meaning: "Tuvalet (Tuvalet nerede diye sorarken sıkça kullanılır)", example: "I just need to pop to the loo.", exampleTr: "Sadece tuvalete uğramam lazım.", context: "Günlük" },
  { word: "Queue", phonetic: "[Kyu]", meaning: "Sıra, kuyruk", example: "Are you in the queue?", exampleTr: "Sırada mısınız?", context: "Günlük" },
  { word: "Rubbish", phonetic: "[Rabiş]", meaning: "Çöp VEYA Saçmalık/Kötü", example: "The weather today is absolutely rubbish.", exampleTr: "Bugün hava tamamen berbat.", context: "Günlük" },
  { word: "Tube", phonetic: "[Tyuub]", meaning: "Londra Metrosu", example: "I'll take the tube to the office.", exampleTr: "Ofise metro ile gideceğim.", context: "Seyahat" },
  { word: "Cuppa", phonetic: "[Kapa]", meaning: "Bir fincan çay (Cup of tea'nin kısaltması)", example: "Fancy a cuppa?", exampleTr: "Bir fincan çay ister misin?", context: "Günlük" },
  { word: "Fancy", phonetic: "[Fensi]", meaning: "İstemek, canı çekmek", example: "Do you fancy going to the pub after work?", exampleTr: "İş çıkışı pub'a gitmek ister misin?", context: "Günlük/Sosyal" },
  { word: "Gutted", phonetic: "[Gatıd]", meaning: "Çok üzgün, hayal kırıklığına uğramış", example: "I was gutted when my team lost the match.", exampleTr: "Takımım maçı kaybettiğinde çok üzülmüştüm.", context: "Günlük" },
  { word: "Dodgy", phonetic: "[Doci]", meaning: "Şüpheli, tekin olmayan, bozuk", example: "Don't eat that meat, it looks a bit dodgy.", exampleTr: "O eti yeme, biraz şüpheli görünüyor.", context: "Günlük" },
  { word: "Chuffed", phonetic: "[Çaft]", meaning: "Çok memnun, gururlu", example: "I'm absolutely chuffed with my new job.", exampleTr: "Yeni işimden çok memnunum.", context: "Günlük" },
  { word: "Banter", phonetic: "[Bentır]", meaning: "Şakalaşma, takılma (İngiliz ofis kültürünün vazgeçilmezi)", example: "It's just a bit of office banter, don't take it seriously.", exampleTr: "Bu sadece biraz ofis şakalaşması, ciddiye alma.", context: "İş/Sosyal" },
  { word: "Cheeky", phonetic: "[Çiiki]", meaning: "Yaramaz, arsız ama sevimli", example: "Let's go for a cheeky pint after work.", exampleTr: "İş çıkışı bir bira içmeye gidelim.", context: "Sosyal" },
  { word: "Gobsmacked", phonetic: "[Gobsmekt]", meaning: "Şok olmuş, ağzı açık kalmış", example: "I was gobsmacked when they offered me the promotion.", exampleTr: "Bana terfi teklif ettiklerinde şok olmuştum.", context: "Günlük" },
  { word: "Skint", phonetic: "[Skint]", meaning: "Parasız, meteliksiz", example: "I can't come out tonight, I'm completely skint until payday.", exampleTr: "Bu gece dışarı çıkamam, maaş gününe kadar tamamen parasızım.", context: "Günlük" },
  { word: "Bloke", phonetic: "[Blouk]", meaning: "Adam, herif (guy kelimesinin İngilizcesi)", example: "He is a really nice bloke.", exampleTr: "O gerçekten iyi bir adam.", context: "Günlük" },
  // İş İngilizcesi
  { word: "Catch up", phonetic: "[Keç ap]", meaning: "Kısa görüşme / arayı kapatma", example: "Let's have a quick catch-up on Monday.", exampleTr: "Pazartesi kısa bir görüşme yapalım.", context: "İş" },
  { word: "To action", phonetic: "[Tu ekşın]", meaning: "Bir şeyi işleme almak", example: "Can you action this email by end of day?", exampleTr: "Bu e-postayı gün sonuna kadar işleme alabilir misin?", context: "İş" },
  { word: "Touch base", phonetic: "[Taç beys]", meaning: "Kısa temas kurmak, durum değerlendirmek", example: "Let's touch base next week.", exampleTr: "Gelecek hafta kısa bir görüşme yapalım.", context: "İş" },
  { word: "Annual leave", phonetic: "[Enyuıl liiv]", meaning: "Yıllık izin", example: "I am on annual leave next week.", exampleTr: "Gelecek hafta yıllık izindeyim.", context: "İş" },
  { word: "Line manager", phonetic: "[Layn menıcır]", meaning: "İlk amir, doğrudan yönetici", example: "You need approval from your line manager.", exampleTr: "Doğrudan yöneticinden onay alman gerekiyor.", context: "İş" },
  { word: "Sick leave", phonetic: "[Sik liiv]", meaning: "Hastalık izni", example: "John is on sick leave today.", exampleTr: "John bugün hastalık izninde.", context: "İş" },
  { word: "Payslip", phonetic: "[Peyslip]", meaning: "Maaş bordrosu", example: "You can view your payslip on the HR portal.", exampleTr: "Maaş bordronuzu İK portalından görüntüleyebilirsiniz.", context: "İş" },
  { word: "CV", phonetic: "[Sii Vii]", meaning: "Özgeçmiş (İngiltere'de Resume yerine CV)", example: "Please send your updated CV.", exampleTr: "Lütfen güncel CV'nizi gönderin.", context: "İş" },
  { word: "Probation", phonetic: "[Probeyşın]", meaning: "Deneme süresi", example: "There is a three-month probation period.", exampleTr: "Üç aylık bir deneme süresi var.", context: "İş" },
  { word: "Redundant", phonetic: "[Rıdandınt]", meaning: "Pozisyonun kapanmasıyla işten çıkarma", example: "50 staff were made redundant.", exampleTr: "50 çalışan işten çıkarıldı.", context: "İş" },
  // Amerikan vs İngiliz Farkları
  { word: "Lift", phonetic: "[Lift]", meaning: "Asansör (US: Elevator)", example: "Let's take the lift to the 5th floor.", exampleTr: "5. kata asansörle çıkalım.", context: "Farklar" },
  { word: "Flat", phonetic: "[Flet]", meaning: "Daire (US: Apartment)", example: "I rent a small flat in zone 2.", exampleTr: "2. bölgede küçük bir daire kirliyorum.", context: "Farklar" },
  { word: "Biscuit", phonetic: "[Biskit]", meaning: "Bisküvi/Kurabiye (US: Cookie)", example: "Would you like a biscuit with your tea?", exampleTr: "Çayının yanına bir bisküvi ister misin?", context: "Farklar" },
  { word: "Chips", phonetic: "[Çips]", meaning: "Kalın patates kızartması (US: Fries)", example: "I'll have fish and chips.", exampleTr: "Balık ekmek alacağım.", context: "Farklar" },
  { word: "Crisps", phonetic: "[Krisps]", meaning: "Paket cips (US: Chips)", example: "Can you buy cheese and onion crisps?", exampleTr: "Peynir ve soğanlı cips alabilir misin?", context: "Farklar" },
  { word: "Pavement", phonetic: "[Peyvmınt]", meaning: "Kaldırım (US: Sidewalk)", example: "Don't ride your bike on the pavement.", exampleTr: "Bisikletini kaldırımda sürme.", context: "Farklar" },
  { word: "Rubbish bin", phonetic: "[Rabiş bin]", meaning: "Çöp kutusu", example: "Throw that in the rubbish bin.", exampleTr: "Şunu çöp kutusuna at.", context: "Farklar" },
  // BBC Words
  ...bbcVocabulary,
];
